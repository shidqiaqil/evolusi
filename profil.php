							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav">
									...
									<li class="nav-item dropdown margin1 active">
										<a class="nav-link dropbtn font1"  style="color:#14bdee;" href="profil.php">Profil <span class="sr-only"></span></a>
									</li>
									<li class="nav-item dropdown margin1">
...
<div class="container">
	<div></div>
	<h2 style="margin-top:10%; text-align:center;"> PROFIL</h2>
	<h2>

	</h2>
	<p style="margin-top:3%;text-align: center; font-size:25px;">EvoLearning adalah sebuah website yang mana user dapat belajar mengenai evolusi industri 4.0. dalam website ini
	user dapat mengasah pengetahuannya mengenai evolusi industri 4.0. selain itu di website ini juga kami menyediakan sebuah video pembelajaran yang mana berguna membuka wawasan mengenai kondisi evolusi industri4.0 di Indonesia.
	user juga akan mendapatkan masukan mengenai apa yang harus dilakukan, untuk menghadapi evolusi industri 4.0 ini. </p>
	<br>
	<br>
	<br>
	<br>
