...
{elapsed_time}
	...
	<body bgcolor=#ffffff>
		...
		<h3 class="text-center">Test Pengetahuan dulu Yuk!</h3>
		<div id="container">
	...
	<div class="container-fluid" style=" margin-top: 5em">
		<a href="materievolusi.php"><button type="button" class="btn btn-warning offset-md-10" style="width:150px; height:50px;">Yuk Ke Video!</button></a>
	</div>
...
let questions = [
    {
        question : "Teknologi Yang bukan termasuk dalam evolusi industri 4.0 adalah? ",
        imgSrc : "img/blog_3.jpg",
        choiceA : "Internet",
        choiceB : "Internet of thing",
        choiceC : "CyberSecurity",
        correct : "A"
    },{
        question : "Berikut merupakan contoh  industri 4.0",
        imgSrc : "img/blog_4.jpg",
        choiceA : "Gojek",
        choiceB : "Playstation",
        choiceC : "Pes2020",
        correct : "A"
